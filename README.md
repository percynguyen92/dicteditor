...
DictEditor là một ứng dụng chỉnh sửa từ điển Android. Ứng dụng được thiết kế để quản lý các mục từ điển Trung-Việt với khả năng chỉnh sửa nâng cao, sắp xếp lại thứ tự nghĩa bằng cách kéo thả và tích hợp dịch thuật hỗ trợ bởi AI.
